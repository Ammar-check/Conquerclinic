...
import painCreamData from "@/data/pain-cream/pain-cream.json"
import reviewsData from "@/data/reviews-data.json";



export default function PainCream(){
const { overallRating, maxRating, totalReviews, platform, reviews } =
    ...
    return(
        <>
         ...
         <main>
            <ProductShowCaseCream data={painCreamData} />
            <BenefitsBar data={painCreamData}/>
            <SplitContentSection data={painCreamData} />
            <Ingredients data={painCreamData} />
            <FaqSection data={painCreamData.faqs} />
            <YouMightLike youMightLikeData={painCreamData.mightLike} />
            <ReviewsSection
