...
import rapamycinData from "@/data/men/rapamycin/rapamycin.json";
import reviewsData from "@/data/reviews-data.json";

export default function Rapamycin() {
  ...
  return (
    <>
      ...
      <main>
        <ProductShowCaseCream data={rapamycinData} />
        <BenefitsBar data={rapamycinData} />
        <SplitContentSection data={rapamycinData} />
        <IncludesSection data={rapamycinData} />
        <QuoteSection data={rapamycinData.quotes} />
        <FaqSection data={rapamycinData.faqs} />
        <YouMightLike youMightLikeData={rapamycinData.mightLike} />
        <ReviewsSection
