...
import gtkcuData from "@/data/ghk-cu-peptide-skin-cream/ghk-cu-peptide-skin-cream.json"
...
const { overallRating, maxRating, totalReviews, platform, reviews } =
    ...
    return(
        <>
         ...
         <main>
            <ProductShowCaseCream data={gtkcuData} />
            <BenefitsBar data={gtkcuData}/>
            <SplitContentSection data={gtkcuData} />
            <QuoteSection data={gtkcuData.quotes} />
            <FaqSection data={gtkcuData.faqs} />
            <YouMightLike youMightLikeData={gtkcuData.mightLike} />
            <ReviewsSection
