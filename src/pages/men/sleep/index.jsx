...
import sleepData from "@/data/men/sleep/sleep.json"
...
const { overallRating, maxRating, totalReviews, platform, reviews } =
    ...
    return(
        <>
         ...
         <main>
            <ProductShowCaseCream data={sleepData} />
            <BenefitsBar data={sleepData}/>
            <SplitContentSection data={sleepData} />
            <IncludesSection data={sleepData} />
            <QuoteSection data={sleepData.quotes} />
            <FaqSection data={sleepData.faqs} />
            <YouMightLike youMightLikeData={sleepData.mightLike} />
            <ReviewsSection
