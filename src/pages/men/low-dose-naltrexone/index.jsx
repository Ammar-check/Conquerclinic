...
import ldnData from "@/data/men/low-dose-naltrexone/low-dose-naltrexone.json";
import reviewsData from "@/data/reviews-data.json";

export default function LowDoseNaltrexone() { 
  ...
  return (
    <>
      ...
      <main>
        <ProductShowCaseCream data={ldnData} />
        <BenefitsBar data={ldnData} />
        <SplitContentSection data={ldnData} />
        <IncludesSection data={ldnData} />
        <QuoteSection data={ldnData.quotes} />
        <FaqSection data={ldnData.faqs} />
        <YouMightLike youMightLikeData={ldnData.mightLike} />
        <ReviewsSection
