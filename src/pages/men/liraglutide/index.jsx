...
import liraglutideData from "@/data/men/liraglutide/liraglutide.json";
import reviewsData from "@/data/reviews-data.json";

export default function Liraglutide() {
  ...
  return (
    <>
      ...
      <main>
        <ProductShowCaseCream data={liraglutideData} />
        <BenefitsBar data={liraglutideData} />
        <SplitContentSection data={liraglutideData} />
        <IncludesSection data={liraglutideData} />
        <FaqSection data={liraglutideData.faqs} />
        <YouMightLike youMightLikeData={liraglutideData.mightLike} />
        <ReviewsSection
