...
import luxeSkinData from "@/data/luxe-skin-cream/luxe-skin-cream.json"
...
const { overallRating, maxRating, totalReviews, platform, reviews } =
    ...
    return(
        <>
         ...
         <main>
            <ProductShowCaseCream data={luxeSkinData} />
            <BenefitsBar data={luxeSkinData}/>
            <SplitContentSection data={luxeSkinData} />
            <QuoteSection data={luxeSkinData.quotes} />
            <FaqSection data={luxeSkinData.faqs} />
            <YouMightLike youMightLikeData={luxeSkinData.mightLike} />
            <ReviewsSection
