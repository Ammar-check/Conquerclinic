...
import zepBoundData from "@/data/men/zepbound/zepbound.json";
import reviewsData from "@/data/reviews-data.json";

export default function ZepBound() {
  ...
  return (
    <>
      ...
      <main>
        <ProductShowCaseCream data={zepBoundData} />
        <BenefitsBar data={zepBoundData} />
        <SplitContentSection data={zepBoundData} />
        <IncludesSection data={zepBoundData} />
        <FaqSection data={zepBoundData.faqs} />
        <YouMightLike youMightLikeData={zepBoundData.mightLike} />
        <ReviewsSection
