 ...
 * ─────────────────────────────────────────────
 * Section 5: Split layout — product image (left)
 * with product detail card (right).
 *
...
const ProductShowcaseSection = () => {
    ...
    return (
        ...
        //                         <StarRating rating={card.reviews.rating} count={card.reviews.count} />
        ...
        //                     {/* Safety link */}
        //                     <a href={card.safetyLink.href} className="product-card__safety-link">
        ...
        // </section>
        <>
         <ProductShowCase data={productShowcaseData} />
        </>
    );
};
